...
},{"lit-html":"../../node_modules/lit-html/lit-html.js"}],"../db-monster-test/db-monster-test-micro.ts":[function(require,module,exports) {
"use strict";
...
function DBMonster() {
  var _a = haunted_w_microtask_1.useState(ENV.generateData().toArray()),
      dbs = _a[0],
      setDbs = _a[1];

  haunted_w_microtask_1.useEffect(function () {
  ...
  return dbs ? lit_html_1.html(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n        <table class=\"table table-striped latest-data\">\n          <tbody>\n            ", "\n          </tbody>\n        </table>\n      "], ["\n        <table class=\"table table-striped latest-data\">\n          <tbody>\n            ", "\n          </tbody>\n        </table>\n      "])), dbs.map(function (db, i) {
    return lit_html_1.html(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n                <tr key=\"", "\">\n                  ", "\n                </tr>\n              "], ["\n                <tr key=\"", "\">\n                  ", "\n                </tr>\n              "])), db.dbname, [lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n                      <td class=\"dbname\">", "</td>\n                    "], ["\n                      <td class=\"dbname\">", "</td>\n                    "])), db.dbname), lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n                      <td class=\"query-count\">\n                        <span class=\"", "\">\n                          ", "\n                        </span>\n                      </td>\n                    "], ["\n                      <td class=\"query-count\">\n                        <span class=\"", "\">\n                          ", "\n                        </span>\n                      </td>\n                    "])), db.lastSample.countClassName, db.lastSample.nbQueries)].concat(db.lastSample.topFiveQueries.map(function (query, j, a) {
      return lit_html_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n                          <td class=\"", "\">\n                            <span class=\"foo\">\n                              ", "\n                            </span>\n                            <div class=\"popover left\">\n                              <div class=\"popover-content\">\n                                ", "\n                              </div>\n                              <div class=\"arrow\"></div>\n                            </div>\n                          </td>\n                        "], ["\n                          <td class=\"", "\">\n                            <span class=\"foo\">\n                              ", "\n                            </span>\n                            <div class=\"popover left\">\n                              <div class=\"popover-content\">\n                                ", "\n                              </div>\n                              <div class=\"arrow\"></div>\n                            </div>\n                          </td>\n                        "])), query.elapsedClassName, query.formatElapsed, query.query);
    })));
  })) : lit_html_1.html(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        loading...\n      "], ["\n        loading...\n      "])));
}

customElements.define("db-monster-test-micro", haunted_w_microtask_1.component(DBMonster, HTMLElement, {
  useShadowDOM: false
}));
...
},{"./db-monster-test.scss":"../db-monster-test/db-monster-test.scss","haunted-w-microtask":"../../lib/haunted-builds/index-w-microtask.js","lit-html":"../../node_modules/lit-html/lit-html.js"}]},{},["../db-monster-test/db-monster-test-micro.ts"], null)
//# sourceMappingURL=db-monster-test-micro.48af8211.map