...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../db-monster-test/db-monster-test.scss":[function(require,module,exports) {
...
},{"lit-html":"../../node_modules/lit-html/lit-html.js"}],"../db-monster-test/db-monster-test.ts":[function(require,module,exports) {
"use strict";
...
require("./db-monster-test.scss");

var haunted_1 = require("haunted");
...
function DBMonster() {
  var _a = haunted_1.useState(ENV.generateData().toArray()),
      dbs = _a[0],
      setDbs = _a[1];

  haunted_1.useEffect(function () {
  ...
  return dbs ? lit_html_1.html(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    <table class=\"table table-striped latest-data\">\n      <tbody>", "</tbody>\n    </table>"], ["\n    <table class=\"table table-striped latest-data\">\n      <tbody>", "</tbody>\n    </table>"])), dbs.map(function (db, i) {
    return lit_html_1.html(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n        <tr key=\"", "\">", "</tr>"], ["\n        <tr key=\"", "\">", "</tr>"])), db.dbname, [lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<td class=\"dbname\">", "</td>"], ["<td class=\"dbname\">", "</td>"])), db.dbname), lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          <td class=\"query-count\">\n            <span class=\"", "\">\n              ", "\n            </span>\n          </td>"], ["\n          <td class=\"query-count\">\n            <span class=\"", "\">\n              ", "\n            </span>\n          </td>"])), db.lastSample.countClassName, db.lastSample.nbQueries)].concat(db.lastSample.topFiveQueries.map(function (query, j, a) {
      return lit_html_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          <td class=\"", "\">\n            <span class=\"foo\">\n              ", "\n            </span>\n            <div class=\"popover left\">\n              <div class=\"popover-content\">\n                ", "\n              </div>\n              <div class=\"arrow\"></div>\n            </div>\n          </td>"], ["\n          <td class=\"", "\">\n            <span class=\"foo\">\n              ", "\n            </span>\n            <div class=\"popover left\">\n              <div class=\"popover-content\">\n                ", "\n              </div>\n              <div class=\"arrow\"></div>\n            </div>\n          </td>"])), query.elapsedClassName, query.formatElapsed, query.query);
    })));
  })) : lit_html_1.html(templateObject_6 || (templateObject_6 = __makeTemplateObject(["loading..."], ["loading..."])));
}

customElements.define("db-monster-test", haunted_1.component(DBMonster, HTMLElement, {
  useShadowDOM: false
}));

if (!window.perfMonitor) {
  perfMonitor = {
    endProfile: function endProfile() {},
    initProfiler: function initProfiler() {},
    startFPSMonitor: function startFPSMonitor() {},
    startMemMonitor: function startMemMonitor() {},
    startProfile: function startProfile() {}
  };
}

perfMonitor.startFPSMonitor();
perfMonitor.startMemMonitor(); // perfMonitor.initProfiler('data update');

perfMonitor.initProfiler('view update');
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6;
},{"./db-monster-test.scss":"../db-monster-test/db-monster-test.scss","haunted":"../../lib/haunted-builds/index.js","lit-html":"../../node_modules/lit-html/lit-html.js"}]},{},["../db-monster-test/db-monster-test.ts"], null)
//# sourceMappingURL=db-monster-test.6414c27a.map